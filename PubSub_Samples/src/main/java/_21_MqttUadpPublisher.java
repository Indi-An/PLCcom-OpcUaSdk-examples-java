 ...
 */
public final class _21_MqttUadpPublisher {

    private _21_MqttUadpPublisher() {
    }

    public static void main(String[] args) {
        PubSubWorkshopHelper.openConsole("Workshop 21 - MQTT UADP Publisher");

        try {
            System.out.println("╔══════════════════════════════════════════════════════════════╗");
            System.out.println("║  PLCcom OPC UA PubSub SDK - Workshop 21: MQTT UADP     ║");
            System.out.println("║                                                              ║");
            System.out.println("║  This publisher sends UADP messages through an MQTT broker.  ║");
            System.out.println("║                                                              ║");
            ...
            System.out.println("║                                                              ║");
            System.out.println("║  Required broker: mqtt://localhost:1883, subscriber 22       ║");
            System.out.println("╚══════════════════════════════════════════════════════════════╝");
            System.out.println();
            ...
            UaPublisherConfiguration config = UaPublisherConfiguration.Build("MotorPublisher", "opcua:Workshop21")
