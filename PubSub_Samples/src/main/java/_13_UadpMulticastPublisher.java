 ...
 */
public final class _13_UadpMulticastPublisher {

    private _13_UadpMulticastPublisher() {
    }

    public static void main(String[] args) {
        PubSubWorkshopHelper.openConsole("Workshop 13 - UADP Multicast Publisher");

        try {
            System.out.println("╔══════════════════════════════════════════════════════════════╗");
            System.out.println("║  PLCcom OPC UA PubSub SDK - Workshop 13: UADP Multicast      ║");
            System.out.println("║                                                              ║");
            System.out.println("║  This publisher sends pressure values to a multicast group.  ║");
            System.out.println("║                                                              ║");
            ...
            System.out.println("║                                                              ║");
            System.out.println("║  Required subscriber: Workshop 14, opc.udp://239.0.0.1:4840  ║");
            System.out.println("╚══════════════════════════════════════════════════════════════╝");
            System.out.println();
            ...
            UaPublisherConfiguration config = UaPublisherConfiguration.Build("PressurePublisher", "opcua:Workshop13")
