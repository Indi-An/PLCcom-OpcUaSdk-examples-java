 ...
 */
public final class _23_SecureMqttTransportUadpPublisher {

    private _23_SecureMqttTransportUadpPublisher() {
    }

    public static void main(String[] args) {
        PubSubWorkshopHelper.openConsole("Workshop 23 - Secure MQTT UADP Publisher");

        try {
            System.out.println("╔══════════════════════════════════════════════════════════════╗");
            System.out.println("║  PLCcom OPC UA PubSub SDK - Workshop 23: Secure MQTT UADP    ║");
            System.out.println("║                                                              ║");
            System.out.println("║  This publisher sends UADP through MQTT over TLS.            ║");
            System.out.println("║                                                              ║");
            ...
            System.out.println("║                                                              ║");
            System.out.println("║  Required broker: mqtts://localhost:8883, subscriber 24      ║");
            System.out.println("╚══════════════════════════════════════════════════════════════╝");
            System.out.println();
            ...
            UaPublisherConfiguration config = UaPublisherConfiguration.Build("SecureMotorPublisher", "opcua:Workshop23")
                    ...
                    .AddDataSet("MotorData", ds -> ds
                            ...
                            .AddField("Speed", new NodeId(2, 2001))
                            .AddField("Current", new NodeId(2, 2002))
                            .AddField("Temperature", new NodeId(2, 2003))
            ...
            try (UaPublisher publisher = new UaPublisher(licenseUser, licenseSerial, config)) {
                ...
                while (!PubSubWorkshopHelper.isEnterPressed(input)) {
                    double speed = 1400.0 + random.nextDouble() * 200.0;
                    double current = 7.5 + random.nextDouble();
                    double temperature = 48.0 + random.nextDouble() * 6.0;
                    ...
                    System.out.printf("Speed=%6.1f rpm, Current=%4.2f A, Temperature=%5.2f °C%n",
