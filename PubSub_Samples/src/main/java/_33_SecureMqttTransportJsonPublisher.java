 ...
 */
public final class _33_SecureMqttTransportJsonPublisher {

    private _33_SecureMqttTransportJsonPublisher() {
    }

    public static void main(String[] args) {
        PubSubWorkshopHelper.openConsole("Workshop 33 - Secure MQTT JSON Publisher");

        try {
            System.out.println("╔══════════════════════════════════════════════════════════════╗");
            System.out.println("║  PLCcom OPC UA PubSub SDK - Workshop 33: Secure MQTT JSON    ║");
            System.out.println("║                                                              ║");
            System.out.println("║  This publisher sends JSON PubSub through MQTT over TLS.     ║");
            System.out.println("║                                                              ║");
            ...
            System.out.println("║                                                              ║");
            System.out.println("║  Required broker: mqtts://localhost:8883, subscriber 34      ║");
            System.out.println("╚══════════════════════════════════════════════════════════════╝");
            System.out.println();
            ...
            UaPublisherConfiguration config = UaPublisherConfiguration.Build("SecureEnergyPublisher", "opcua:Workshop33")
