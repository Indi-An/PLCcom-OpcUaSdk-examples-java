 ...
 */
public final class _32_MqttJsonSubscriber {

    private _32_MqttJsonSubscriber() {
    }

    public static void main(String[] args) {
        PubSubWorkshopHelper.openConsole("Workshop 32 - MQTT JSON Subscriber");

        try {
            System.out.println("╔══════════════════════════════════════════════════════════════╗");
            System.out.println("║  PLCcom OPC UA PubSub SDK - Workshop 32: MQTT JSON           ║");
            System.out.println("║                                                              ║");
            System.out.println("║  This subscriber receives JSON PubSub messages through MQTT. ║");
            System.out.println("║                                                              ║");
            ...
            System.out.println("║                                                              ║");
            System.out.println("║  Required broker: mqtt://localhost:1883, publisher 31        ║");
            System.out.println("╚══════════════════════════════════════════════════════════════╝");
            System.out.println();
            ...
            UaSubscriberConfiguration config = UaSubscriberConfiguration.Build("EnergySubscriber")
