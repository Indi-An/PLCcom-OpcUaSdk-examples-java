 ...
 */
public final class _24_SecureMqttTransportUadpSubscriber {

    private _24_SecureMqttTransportUadpSubscriber() {
    }

    public static void main(String[] args) {
        PubSubWorkshopHelper.openConsole("Workshop 24 - Secure MQTT UADP Subscriber");

        try {
            System.out.println("╔══════════════════════════════════════════════════════════════╗");
            System.out.println("║  PLCcom OPC UA PubSub SDK - Workshop 24: Secure MQTT UADP    ║");
            System.out.println("║                                                              ║");
            System.out.println("║  This subscriber receives UADP through MQTT over TLS.        ║");
            System.out.println("║                                                              ║");
            ...
            System.out.println("║                                                              ║");
            System.out.println("║  Required broker: mqtts://localhost:8883, publisher 23       ║");
            System.out.println("╚══════════════════════════════════════════════════════════════╝");
            System.out.println();
            ...
            UaSubscriberConfiguration config = UaSubscriberConfiguration.Build("SecureMotorSubscriber")
